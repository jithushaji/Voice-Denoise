...
audio = audio_files_to_numpy(args['audio_dir_prediction'], args['audio_input_prediction'], args['sample_rate'],
...
sf.write(args['dir_save_prediction'] + args['audio_output_prediction'], denoise_long[0, :], args['sample_rate'])
